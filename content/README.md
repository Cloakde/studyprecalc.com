...
Authored educational content belongs here.

- `questions/` - original practice questions.
- `explanations/` - explanation text and step-by-step solution content.
- `media/` - content-specific media references or metadata.
- `templates/` - owner-facing import templates and checklists for original question packs.
